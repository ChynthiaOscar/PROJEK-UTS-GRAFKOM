...
function generateKepala(x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ) {
    ...
    var colors = [];
    var rainbowColors = [
        [15 / 255, 82 / 255, 186 / 255] // Warna A1C398
    ];
...
function main() {
    ...
    var kepala = generateKepala(0, 0, 0.5, 0.5, 50, 1.2, 1, 1); // badan: x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
    ...
    // Badan
    var badan = generateBadan(0, -0.8, 0.5, 0.4, 50, 1, 1.2, 0.8); // badan: x, y, z, radius, segments, ovalScaleX, ovalScaleY, ovalScaleZ
